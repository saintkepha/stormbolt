...
(function() {
  ...
  StormBolt = (function(_super) {
    ...
    StormBolt.prototype.run = function(config) {
      var ca, cacert, chain, connected, err, i, line, res, retries, selfconfig, server, storm, _i, _len, _ref;
      if (config != null) {
    ...
    StormBolt.prototype.listen = function(port, options, callback) {
      ...
      server.on('clientError', (function(_this) {
        return function(exception, securePair) {
          _this.log('TLS handshake error:', exception);
          return _this.log('TLS error with securePair:', securePair);
        };
      })(this));
      server.on('error', (function(_this) {
        return function(err) {
