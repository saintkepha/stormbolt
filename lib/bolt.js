    ...
    function BoltStream(id, stream) {
      ...
      this.bstream.on('data', (function(_this) {
        return function(beacon) {
          ...
          return _this.validity = _this.config.beaconValidity;
        };
      })(this));
      ...
      if ((this.config.uplinks != null) && this.config.uplinks.length > 0) {
        ...
        async.forever((function(_this) {
          return function(next) {
            ...
            if (!connected) {
              _this.uplink = _this.config.uplinks[i++];
      ...
      server = tls.createServer(options, (function(_this) {
        return function(stream) {
          ...
          try {
            ...
            _this.log((_ref = 'server connected from #{cname}: ' + stream.authorized) != null ? _ref : {
