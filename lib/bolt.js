...
(function() {
  ...
  BoltStream = (function(_super) {
    ...
    BoltStream.prototype.relay = function(request, response) {
      var err, relay, reply, _ref;
      if (_ref = request.target, __indexOf.call(this.capability, _ref) < 0) {
        callback(new Error("unable to forward request to " + this.id + " for unsupported port"));
      }
  ...
  StormBolt = (function(_super) {
    ...
    StormBolt.prototype.run = function(config) {
      var ca, cacert, chain, connected, err, i, line, res, retries, server, storm, _i, _len, _ref;
      if (config != null) {
      ...
      try {
        ...
        this.activate(storm, (function(_this) {
