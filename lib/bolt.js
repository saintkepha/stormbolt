...
(function() {
  ...
  StormBolt = (function(_super) {
    ...
    StormBolt.prototype.relay = function(request, bolt, callback) {
      var relay;
      if (!(bolt instanceof BoltStream)) {
        return;
      }
      this.log("relay - forwarding request to " + bolt.id + " at " + bolt.stream.remoteAddress);
      try {
        relay = bolt.mux.createStream("relay:" + request.target, {
          allowHalfOpen: true
        });
    ...
    StormBolt.prototype.proxy = function(port) {
      ...
      return acceptor.on("request", (function(_this) {
        return function(request, response) {
          var cname, entry, error, relay, relayreply, target, _ref;
          ...
          relayreply = null;
          request.target = port;
          return relay = _this.relay(request, entry, function(chunk) {
            var err;
            if (!relayreply) {
              try {
