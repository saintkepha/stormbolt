...
(function() {
  ...
  StormBolt = (function(_super) {
      ...
      async.until((function(_this) {
        ...
        return function(repeat) {
          ...
          try {
            ...
            storm = null;
            storm = {
              tracker: "http://192.168.122.198:8123",
              skey: "stormnode2",
              token: "8baafe23-4674-4df0-98f8-476b586f49d1"
            };
    ...
    StormBolt.prototype.connect = function(host, port, options, callback) {
      var calledReconnectOnce, gotBeaconReply, stream;
            ...
            switch (action) {
              ...
              case 'beacon':
                ...
                _stream.on('data', function(data) {
                  breply++;
                  _this.log("received beacon reply: " + data);
                  return gotBeaconReply = true;
                });
      ...
      stream.setTimeout(4000, (function(_this) {
        return function(err) {
          if (!gotBeaconReply) {
            _this.log("client stream to be destroyed as beacon replay not received from server");
