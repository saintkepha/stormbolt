...
(function() {
  ...
  BoltStream = (function(_super) {
    ...
    function BoltStream(id, stream, config) {
      ...
      this.mux.on('connection', this.handleAction);
    ...
    BoltStream.prototype.handleAction = function(_stream) {
      var action, breply, bsent, incoming, request, target, _forwardingPorts, _ref, _ref1, _ref2;
      ...
      _forwardingPorts = ((_ref1 = this.config) != null ? _ref1.allowedPorts : void 0) || [];
      switch (action) {
        case 'capability':
          this.log('sending capability information...');
          if ((_forwardingPorts != null) && _forwardingPorts instanceof Array) {
            _stream.write(_forwardingPorts.join(','));
          }
          return _stream.end();
        case 'beacon':
          ...
          return async.whilst((function(_this) {
            return function() {
              var _ref3;
              return bsent - breply < ((_ref3 = _this.config) != null ? _ref3.beaconRetry : void 0);
            };
          })(this), (function(_this) {
            return function(repeat) {
              ...
              bsent++;
              return setTimeout(repeat, ((_ref3 = _this.config) != null ? _ref3.beaconInterval : void 0) * 1000);
            };
          })(this), (function(_this) {
            return function(err) {
              if (err == null) {
